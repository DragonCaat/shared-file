 ...
 * gridView的适配器
 * */
public class GridViewShowFileAdapter extends BaseAdapter {
     ...
     * 通过构造方法将数据引入
     * */
    public GridViewShowFileAdapter(Context context, ArrayList<String>arrayList){
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null){
            holder= new Holder();
            convertView = View.inflate(mContext, R.layout.show_file_item, null);
